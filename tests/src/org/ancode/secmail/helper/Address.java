...
public class Address extends TestCase {
    ...
    public void testParseWithMissingEmail() {
        org.ancode.secmail.mail.Address[] addresses =  org.ancode.secmail.mail.Address.parse("NAME ONLY");
    ...
    public void testPraseWithValidEmail() {
        org.ancode.secmail.mail.Address[] addresses =  org.ancode.secmail.mail.Address.parse("Max Mustermann <maxmuster@mann.com>");
        assertEquals(1, addresses.length);
    ...
    public void testPraseWithValidEmailMulti() {
        org.ancode.secmail.mail.Address[] addresses =  org.ancode.secmail.mail.Address.parse("lorem@ipsum.us,mark@twain.com");
